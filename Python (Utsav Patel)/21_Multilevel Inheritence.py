...
#     def __init__(self, first_name, last_name, phone, id, department):
#         Employee.__init__(self, first_name, last_name, phone)
#         self.id = id
#         self.department = department
#
# class EmployeeInfo(EmployeeDetails):
#     def __init__(self, first_name, last_name, phone, id, department, post, salary):
#         EmployeeDetails.__init__(self, first_name, last_name, phone, id, department)
#         self.post = post
#         self.salary = salary
#
#
